...
const { PATH_TO_PDF_FILE, PATH_TO_SIGNED_PDF_FILE, PATH_TO_P12_CERTIFICATE, P12_PASSWORD, SIGNATURE_NAME, SIGNATURE_LOCATION, SIGNATURE_EMAIL, } = process.env;
export async function signAndWriteDocument() {
    const signedPdf = await sign(fs.readFileSync(PATH_TO_PDF_FILE), fs.readFileSync(PATH_TO_P12_CERTIFICATE), P12_PASSWORD, {
